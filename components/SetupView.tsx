      ...
      <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in duration-500">
        <div className="text-center space-y-4">
          ...
          <div className="w-24 h-24 bg-slate-900 rounded-full mx-auto flex items-center justify-center shadow-2xl shadow-black border-4 border-slate-800 relative">
            <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-slate-950 font-black text-2xl">
              8
            </div>
        ...
        <button
          disabled={!isReady}
          onClick={() => onComplete(names.filter(n => n.trim().length > 0))}
